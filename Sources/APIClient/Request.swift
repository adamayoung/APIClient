...
public struct Request<Response> {
    ...
    public let query: [String: CustomStringConvertible?]?
    let body: AnyEncodable?

    init(method: HTTPMethod, path: String, query: [String: CustomStringConvertible?]? = nil,
    ...
    public static func get(_ path: String, query: [String: CustomStringConvertible?]? = nil) -> Request {
    ...
    public static func delete(_ path: String, query: [String: CustomStringConvertible?]? = nil) -> Request {
        Request(method: .delete, path: path, query: query)
    }

    public static func options(_ path: String, query: [String: CustomStringConvertible?]? = nil) -> Request {
        Request(method: .options, path: path, query: query)
    }

    public static func head(_ path: String, query: [String: CustomStringConvertible?]? = nil) -> Request {
        Request(method: .head, path: path, query: query)
    }

    public static func trace(_ path: String, query: [String: CustomStringConvertible?]? = nil) -> Request {
